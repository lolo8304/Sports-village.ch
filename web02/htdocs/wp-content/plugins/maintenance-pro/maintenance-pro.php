...
/*
	...
	Plugin URI: http://plugins.fruitfulcode.com/maintenance/
	Description: PRO it's extended functionality for <a href="http://wordpress.org/plugins/maintenance/">Maintenance</a> WordPress plugin. They works together.
	Version: 2.2.1
	Author: fruitfulcode
...
class maintenance_pro  {
		...
		function activation() {
			...
			$default_arr  = array(
				...
				'gallery_array'		=> array(),
				'expiry_date_start'	=> date_i18n( 'Y-m-d h:i a', strtotime( current_time('mysql', 1) )), 
				'expiry_date_end'	=> date_i18n( 'Y-m-d h:i a', strtotime( current_time('mysql', 1) )+60*60*24*30),
